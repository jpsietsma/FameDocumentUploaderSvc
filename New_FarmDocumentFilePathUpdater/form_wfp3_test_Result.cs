...
namespace New_FarmDocumentFilePathUpdater
{
    ...
    public partial class form_wfp3_test_Result
    {
        ...
        public Nullable<int> attachedSpecifications { get; set; }
        ...
        public Nullable<int> fixedText { get; set; }
        public Nullable<int> fixedText2 { get; set; }
